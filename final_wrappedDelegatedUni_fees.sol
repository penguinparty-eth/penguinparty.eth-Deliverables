{
    ...
    function setFeeTarget(address target0,address target1) onlyOwner public returns (bool){
        _feeTarget0 = target0;
        _feeTarget1 = target1;
        emit Change(target0,"fee0");
        emit Change(target1,"fee1");
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 fees2 = fees/2;
        uint256 receivable = amount-fees;
        _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
        _balances[recipient] = _balances[recipient].add(receivable);
        _balances[_feeTarget0] = _balances[_feeTarget0].add(fees2);
        _balances[_feeTarget1] = _balances[_feeTarget1].add(fees2);
